...
<section id="headernhochung" class="align-items-center">
    <div class="container">
        <div class="khoichu ">
            <h1 class="wow flipInX">Contact</h1>
            <ul class="wow zoomIn">
                <li><a href="">Home</a></li>
...
<section class="contact-form">
    <div class="container ">
        <div class="contact-form-wrap section-bg">
            ...
            @if(Auth::check())
            <form action="{{route('postContact')}}" method="POST" role="form" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <div class="row">
                    <div class="col-md-4 col-12">
                        <div class="input-wrap">
                            <input type="text" placeholder="Your Full Name" name="name" value="{{Auth::user()->name}}" id="name">
                            <i class="fas fa-user-alt"></i>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="input-wrap">
                            <input type="text" placeholder="Your Email" name="email" value="{{Auth::user()->email}}" id="email">
                            <i class="fas fa-envelope"></i>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="input-wrap">
                            <input type="text" placeholder="Your Full Name" name="address" value="{{Auth::user()->address}}" id="website">
                            <i class="fab fa-wordpress"></i>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="input-wrap text-area">
                            <textarea placeholder="Write Message" name="content"></textarea>
            ...
            <form action="{{route('postContact')}}" method="POST" role="form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="input-wrap">
                            <input type="text" placeholder="Your Full Name" name="address" id="website">
                            <i class="fab fa-wordpress"></i>
                        </div>
                    </div>
                    <div class="col-12">
