            ...
            <div class="row">
                ...
                <div class="col-md-12" style="margin:0 auto">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('admin.categoryService.store')}}" method="POST" role="form" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group @error('name') has-error @enderror">
                                    ...
                                    <input name="linkVideoService" id="name" type="text" class="form-control  " placeholder="Thêm link video" value="{{old('name')}}">
