            ...
            <div class="row">
                ...
                <div class="col-md-12" style="margin:0 auto">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('categoryService.store')}}" method="POST" role="form" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                            <input type="file" class="custom-file-input" name="imageHover" placeholder="Chọn ảnh" required multiple/>
                                            <label class="custom-file-label" for="exampleInputFile">Chọn Ảnh</label>        
                                    </div>
                                    @error('image')
                                        <small style="color:red">{{$message}}</small>
