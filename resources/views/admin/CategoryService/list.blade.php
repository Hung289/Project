      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <!-- <form class="form-inline ml-3" style="float:right;margin-right:30px" action="{{route('admin.searchCateService')}}">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('admin.categoryService.edit',['categoryService'=>$CS->id])}}" class="btn btn-primary"><i class="far fa-edit"></i></a>
                    <button type="botton" url="{{route('admin.categoryService.destroy',['categoryService'=>$CS->id])}}" class="btn btn-danger nutxoa"><i class="fas fa-trash"></i></button>
                  </td>
                </tr>
                @endforeach
              </tbody>
