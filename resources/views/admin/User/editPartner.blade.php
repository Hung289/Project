                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form id="form_update_cus" action="{{route('admin.postEditAdminPartner',['id'=>$users->id])}}" method="POST" enctype="multipart/form-data">
                                            <div class="card-body">
                                            ...
                                            <div class="card-footer">
                                                <button type="submit" id="post_up_cus" class="btn btn-primary">Cập Nhật Lại Thông Tin</button>
                                            </div>
