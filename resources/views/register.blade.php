        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" method="POST" action="{{route('postRegisterWeb')}}">
                        ...
                        <div>
                            <a href="{{route('indexWeb')}}">Về trang web</a>
                            <br>
                            <a href="{{route('getloginWeb')}}" class="text-center">Tôi đã có tài Khoản. Đi đến trang đăng nhập</a>
                        </div>
                    </form>

                    <div class="login100-more" style="background-image: url('public/web/images/img/bg/hero-bg-2.jpg');">
                    </div>
                </div>
            </div>
        </div>
