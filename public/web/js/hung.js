$(function () {
    ...
    $(document).on(
        "click",
        ".header .mobilemenu .meannav ul li i",
        function () {
            var danhmuc = $(this).data("class");
            ...
            if (
                $(".header .mobilemenu .meannav ul li .fas").hasClass("fa-plus")
            ) {
    ...
    // $('.header .mobilemenu i').each(function(){
    //     if($('.fas').hasClass('fa-bars')){
    //         $('.header .mobilemenu i' ).addClass('fa-minus');
    //     }
    // }
